...
} from '../../src/utils/groq.utils';

describe('Product Service', () => {
  const mockPrisma = prisma as any;
  const mockGenerateProductDescription =
    generateProductDescription as jest.MockedFunction<
      typeof generateProductDescription
    >;
  const mockGenerateProductRecommendations =
    generateProductRecommendations as jest.MockedFunction<
      typeof generateProductRecommendations
    >;
  ...
  describe('createProduct', () => {
    ...
    it('should create product with provided description', async () => {
      ...
      mockPrisma.investment_products.create.mockResolvedValue(
        mockCreatedProduct,
      );
  ...
  describe('updateProduct', () => {
    ...
    it('should update product successfully', async () => {
      ...
      mockPrisma.investment_products.findUnique.mockResolvedValue(
        existingProduct,
      );
      mockGenerateProductDescription.mockResolvedValue(generatedDescription);
    ...
    it('should throw error when no update data provided', async () => {
      await expect(
        productService.updateProduct('1', {} as any),
  ...
  describe('getRecommendedProducts', () => {
    it('should get recommended products for user', async () => {
      const mockUser = { id: 'user-1', risk_appetite: 'moderate' as const };
      const mockProducts = [
        {
          id: '1',
          name: 'Product 1',
      ...
      mockPrisma.investment_products.findMany.mockResolvedValue(mockProducts);
      mockGenerateProductRecommendations.mockResolvedValue(
      ...
      expect(mockGenerateProductRecommendations).toHaveBeenCalledWith(
        'moderate',
    ...
    it('should throw error when user not found', async () => {
      ...
      await expect(
        productService.getRecommendedProducts('non-existent'),
